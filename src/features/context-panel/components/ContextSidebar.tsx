            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  ...
                  <span className="font-header text-2xl leading-none text-[var(--color-text-secondary)]">
                    / {lowF}°
                  </span>
                </div>
                <div className="flex gap-4 mb-1">
                  <span className="font-mono text-xs tracking-label-md uppercase text-[var(--color-text-secondary)]">
                    High
                  </span>
                  <span className="font-mono text-xs tracking-label-md uppercase text-[var(--color-text-secondary)]">
                    Low
