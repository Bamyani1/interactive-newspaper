...
export const QUESTION_PROMPTS = [
    {
        lens: "Compare eras",
        question:
            "How did students describe the cost of college in the 1950s compared with the 2000s?",
    },
    {
        lens: "Compare eras",
    ...
    },
    {
        lens: "Compare eras",
        question:
            "How did The Transcript’s language around mental health change over the decades?",
    },
    {
        lens: "Compare eras",
        question:
            "Compare student reactions to national elections in the 1960s and the 1990s.",
    },
    {
        lens: "Compare eras",
        question:
            "How did campus debates over race and equality change from the 1960s to the 1990s?",
    },
    {
        lens: "Compare eras",
        question:
            "Which campus traditions survived from 1950 to 2006—and which disappeared?",
    },
    {
        lens: "Student voices",
        question:
            "What did students praise—and criticize—about campus life in the 1970s?",
    },
    {
        lens: "Student voices",
        question:
    ...
    },
    {
        lens: "Student voices",
        question:
            "How did students push back against dorm rules, curfews, and dress codes?",
    },
    {
        lens: "Student voices",
        question:
            "What did women students say about equality on campus after Title IX?",
    },
    {
        lens: "Student voices",
        question:
            "How did students respond to rising tuition and financial pressure?",
    },
    {
        lens: "Student voices",
        question:
            "What do letters to the editor reveal about the campus debates of their day?",
    },
    {
        lens: "Campus life",
        question:
            "What did a typical Friday night look like for OWU students in the 1950s?",
    },
    {
        lens: "Campus life",
        question:
            "How did computers first enter campus life, and what did students think of them?",
    },
    {
        lens: "Campus life",
        question:
            "What were students eating, wearing, and listening to in the 1980s?",
    },
    {
        lens: "Campus life",
    ...
    },
    {
        lens: "Campus life",
        question:
            "What did first-year students worry about across different decades?",
    },
    {
        lens: "Campus life",
    ...
    },
    {
        ...
        question:
            "Show me photographs of student protests and explain what was happening.",
    },
    {
        lens: "In the photographs",
        question:
            "Find photographs that capture everyday dorm life across the decades.",
    },
    {
        lens: "In the photographs",
    ...
    },
    {
        lens: "In the photographs",
        question:
            "Show how sports photography changed as women’s varsity teams expanded.",
    },
    {
        lens: "In the photographs",
        question:
...
export const QUESTION_POOL: readonly string[] = QUESTION_PROMPTS.map(
    ({ question }) => question,
);
...
export function getQuestionPrompt(
    question: string,
): ArchiveQuestionPrompt | undefined {
...
export function pickSuggestions(date: Date, exclude?: string): string[] {
    ...
    return [0, 1, 2].map((offset) => {
        const lens =
            QUESTION_LENSES[(lensStart + offset) % QUESTION_LENSES.length];
