...
export const ThemeModeToggle: React.FC<ThemeModeToggleProps> = ({ iconOnly = false }) => {
  ...
  if (iconOnly) {
    return (
      ...
      >
        <Sun className="theme-mode-toggle__light-action w-4 h-4 opacity-80" aria-hidden />
        <Moon className="theme-mode-toggle__dark-action w-4 h-4 opacity-80" aria-hidden />
      </button>
    );
  }
