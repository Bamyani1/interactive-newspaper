    ...
    if (this.state.hasError) {
      ...
      return (
        <main
          id="main-content"
          tabIndex={-1}
          className="min-h-screen flex items-center justify-center p-8 bg-[var(--color-bg-primary)] text-[var(--color-text-primary)]"
        >
          <div className="max-w-md text-center space-y-4">
            ...
            <p className="text-sm opacity-70">We couldn’t display this page. Please try again.</p>
            <button
              onClick={() => {
