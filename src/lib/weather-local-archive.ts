...
function buildRecord(archive: SlimArchive, date: string, index: number): DailyWeatherRecord | null {
...
export async function getLocalWeatherByDate(date: string): Promise<DailyWeatherRecord | null> {
