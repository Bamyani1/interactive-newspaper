      ...
      <main id="main-content" tabIndex={-1} className="w-full flex-1">
        <div className="max-w-3xl mx-auto px-6 py-10">
          ...
          <p className="text-base text-[var(--color-text-secondary)] leading-relaxed mb-4">
            Send us a note about an OCR error, missing context, accessibility need, or archival
            question. Please include the edition date or article headline when you can.
          </p>
          <a
