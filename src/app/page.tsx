...
export default function Home() {
  ...
  const selectedEdition =
    userSelectedEdition ?? (editions.length > 0 ? editions[editions.length - 1] : null);
        ...
        <main id="main-content" tabIndex={-1} className="cinema-content">
          <div className="cinema-paper">
            <header className="cinema-masthead">
              ...
              <p className="cinema-subtitle">Read the paper. Ask across decades.</p>
            </header>

            <div
              className={`cinema-paper-grid ${isPickerOpen ? "cinema-paper-grid--picker-open" : ""}`}
            >
              {/* LEFT: Ask flow — daily rotating prompt + Ask CTA */}
              <div className={`cinema-col-brand ${isPickerOpen ? "cinema-col-brand--hidden" : ""}`}>
                <LandingAskTeaser />
                <Link href="/ask" className="cinema-btn-stamp">
                ...
                {!isPickerOpen &&
                  (selectedEdition ? (
                    ...
                    >
                      ...
                      <span className="cinema-btn-arrow" aria-hidden="true">
                        →
                      </span>
                    </Link>
                  ) : (
