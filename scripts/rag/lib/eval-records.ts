...
export function deepSortKeys(value: unknown): unknown {
  ...
  return Object.fromEntries(entries.map(([key, entry]) => [key, deepSortKeys(entry)]));
}
 ...
 */
export function freezeCandidateOutputs(runFile: EvalRunFile): FreezeCandidateReceipt {
