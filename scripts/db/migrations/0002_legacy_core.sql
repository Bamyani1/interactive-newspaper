-- Legacy content tables exactly as production has them, expressed once under
-- the canonical ledger. Every statement converges an existing database of the
-- same shape (IF NOT EXISTS / ADD COLUMN IF NOT EXISTS) and builds it fresh
-- from nothing.
