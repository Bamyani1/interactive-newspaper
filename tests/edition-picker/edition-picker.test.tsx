...
describe("EditionPicker", () => {
  it("renders closed with Pick Edition button by default", () => {
    render(<EditionPicker editions={EDITIONS} selectedEdition={null} onSelect={vi.fn()} />);
  ...
  it("calls onSelect when an edition is clicked", () => {
    ...
    render(<EditionPicker editions={EDITIONS} selectedEdition={null} onSelect={onSelect} />);
    fireEvent.click(screen.getByText("Pick Edition"));
  ...
  it("returns focus to the closed trigger after Escape", async () => {
    render(<EditionPicker editions={EDITIONS} selectedEdition={EDITIONS[0]} onSelect={vi.fn()} />);
    fireEvent.click(screen.getByRole("button", { name: /selected edition/i }));
