...
describe("Search accessibility", () => {
  ...
  it("announces loading and result counts while exposing busy state", () => {
    ...
    expect(status).toHaveTextContent("Searching for campus.");
    ...
    expect(screen.getByRole("status")).toHaveTextContent("1 result found for campus.");
  ...
  it("disables the search spinner animation for reduced motion", () => {
    render(<SearchBar value="campus" onChange={vi.fn()} isLoading autoFocus={false} />);
