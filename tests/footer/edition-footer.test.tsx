...
describe("EditionFooter", () => {
  ...
  it("renders shared footer links", () => {
    render(<EditionFooter onNextEdition={vi.fn()} canGoToNextEdition />);
  ...
  it("renders and wires the See Next Edition button", () => {
    ...
    render(<EditionFooter onNextEdition={onNextEdition} canGoToNextEdition />);
  ...
  it("disables button when next edition is unavailable", () => {
    render(<EditionFooter onNextEdition={vi.fn()} canGoToNextEdition={false} />);

    expect(screen.getByRole("button", { name: "See Next Edition" })).toBeDisabled();
  });

  it("still renders semantic footer landmark", () => {
    const { container } = render(<EditionFooter onNextEdition={vi.fn()} canGoToNextEdition />);
